...
public class ConsumerBuilder {
    ...
    static {
        ...
        apiService = (RaceTestService) consumer // 获取代理对象
    ...
    public void testFutureCall() {
        ...
        try {
            String result = (String) ResponseFuture.getResponse(3000);  // 从回调获取response
    ...
    public void testCallback() {
        ...
        try {
            RaceDO resultDo = (RaceDO) listener.getResponse();  // ** 通过回调获取response
        } catch (InterruptedException e) {
        } finally {
